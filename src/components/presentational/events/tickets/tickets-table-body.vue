<template>
  ...
  <div v-if="!isLoading">
    <div v-for="(ticket,index) in ticketsList" :key="ticket?._id" class="bg-site__light__gray p-5 flex items-center mb-2.5" >
      <div class="w-[15%] px-2">
      ...
      <div class="w-[15%] px-2">
        <p class="text-primary__color font-light">{{ ticket?.tickets }}</p>
      </div>
      <div>
