                ...
                <div class="d-flex">
                    ...
                    <div class="g-popup-content p-5 d-flex flex-column justify-content-center">
                        <div class="page-title">
                            ...
                            <p class="d-hex-color mt-2">Subscribe to receive the latest news and promotions directly to your inbox.</p>
                        </div>
                        <div class="popup-form">
                            <div class="g-form-col">
                                <form class="mt-2 pt-1" data-gtm-form-interact-id="2" method="POST" @submit.prevent="submitNewsLetterForm">
                                    <span v-if="errorMessage" class="text-center mt-3 text-danger">{{ errorMessage }}</span>
                                    ...
                                    <span class="mt-4 input-f g-input undefined" required="true">
                                        <span class="position-relative">
                                            <label class="text-lg text-primary__color mb-1 block d-flex">What side are you interested on?</label>  
                                            <span class="d-flex text-center gap-3 mt-3 radio-btn-box">
                                                <a @click="formFields.userType = 'Seeker'" href="javascript:;" class="w-50 p-4 pt-5 ">
                                                    <img :src="BASE_URL+'placeholder.png'" alt="img" />
                                                    <span>Seeker</span>
                                                    <input type="radio"  name="userType" v-model="formFields.userType" value="Seeker">
                                                </a>
                                                <a @click="formFields.userType = 'Organization'" href="javascript:;" class="w-50 p-4 pt-5 ">
                                                    <img :src="BASE_URL+'placeholder_org.png'" alt="img" />
                                                    <span>Organization</span>
                                                    <input type="radio"  name="userType" v-model="formFields.userType"  value="Organization">
                                                </a>
                                            </span>
                                        </span>
                                    </span>                                                                   
